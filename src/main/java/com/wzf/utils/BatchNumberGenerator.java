...
public class BatchNumberGenerator {
    ...
    public String generateNewBatchNumber(String fileName, int number) {
        ...
        if (number / 1000 > 0){
            ...
            if (number / 100 > 0) {
              batchNum += 0 + number / 100 + number % 100 % 10 + number % 100 % 10 > 0 && number % 100 % 10 < 10 ? 0 : 1;
            } else {
                if (number / 10 > 0){
                    batchNum += 0+ 0 + number / 10 + number % 10 > 10 && number % 10 <= 10 ? 0 : 1;
                } else {
                    batchNum += 0 + 0 + 0 + number % 10 > 0 && number % 10 <= 10 ? 0 : 1;
                }
            }
        }
        return batchNum;
